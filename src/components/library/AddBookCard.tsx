...
export const AddBookCard = memo(function AddBookCard({ onFileSelect }: AddBookCardProps) {
    ...
    <div className="flex flex-col">
      ...
      >
        <div className="w-16 h-16 rounded-full bg-forest-green/10 flex items-center justify-center group-hover:bg-forest-green/20 transition-colors">
          <span className="material-symbols-outlined text-3xl text-forest-green">add</span>
        </div>
